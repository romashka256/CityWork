...
import com.producticity.ui.customviews.bottomnav.util.ViewUtils;
...
public class BubbleToggleView extends RelativeLayout {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        int leftPadding = (int) context.getResources().getDimension(R.dimen.default_nav_item_left_padding);
        int rightPadding = (int) context.getResources().getDimension(R.dimen.default_nav_item_right_padding);
        ...
        if (attrs != null) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                    ...
                    icon = AppCompatResources.getDrawable(getContext(), ta.getResourceId(R.styleable.BubbleToggleView_bt_icon, R.drawable.ic_timer_icon_focused));
                ...
                leftPadding = (int) ta.getDimension(R.styleable.BubbleToggleView_bt_leftPadding, leftPadding);
                rightPadding = (int) ta.getDimension(R.styleable.BubbleToggleView_bt_rightPadding, rightPadding);
        ...
        if (icon == null)
            icon = ContextCompat.getDrawable(context, R.drawable.ic_timer_icon_focused);

        //set the default shape
        if (shape == null)
            shape = ContextCompat.getDrawable(context, R.drawable.transitions_navigation_bg);
        ...
        bubbleToggleItem.setLeftPadding(leftPadding);
        bubbleToggleItem.setRightPadding(rightPadding);
        ...
        setPadding(
                bubbleToggleItem.getLeftPadding(),
                bubbleToggleItem.getInternalPadding(),
                bubbleToggleItem.getRightPadding(),
                bubbleToggleItem.getInternalPadding());
        post(() -> {
    ...
    private void updateBadge(Context context) {
        ...
        Drawable drawable = ContextCompat.getDrawable(context, R.drawable.tabbg);
